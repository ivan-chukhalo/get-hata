...
const Footer = () => {
  return (
    <div id="footer" className="pt-10 px-4 md:px-20 lg:px-32 bg-gray-900 w-full overflow-hidden">
      <div className="container mx-auto flex flex-col md:flex-row items-start justify-between text-white">
        <div className="w-full md:w-1/3 mb-8 md:mb-0">
          <img src={assets.logo_dark} alt="logo" />
          <p className="mt-4 text-gray-400">
            © 2025 YourCompanyName. All rights reserved. Built with passion and
            purpose in Ukraine 🇺🇦
          </p>
        </div>
        <div className="w-full md:w-1/3 mb-8 md:mb-0">
